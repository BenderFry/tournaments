...
tournament_data = {
    'players': {
        ...
        'A3': {'group': 'A', 'scored_goals': 0, 'conceded_goals': 0, 'points': 0, 'display_name': 'A3', 'wins': 0,
               'draws': 0, 'losses': 0},
        'A4': {'group': 'A', 'scored_goals': 0, 'conceded_goals': 0, 'points': 0, 'display_name': 'A4', 'wins': 0,
               'draws': 0, 'losses': 0},
        ...
        'B3': {'group': 'B', 'scored_goals': 0, 'conceded_goals': 0, 'points': 0, 'display_name': 'B3', 'wins': 0,
               'draws': 0, 'losses': 0},
        'B4': {'group': 'B', 'scored_goals': 0, 'conceded_goals': 0, 'points': 0, 'display_name': 'B4', 'wins': 0,
               'draws': 0, 'losses': 0},
        ...
        'C3': {'group': 'C', 'scored_goals': 0, 'conceded_goals': 0, 'points': 0, 'display_name': 'C3', 'wins': 0,
               'draws': 0, 'losses': 0},
        'C4': {'group': 'C', 'scored_goals': 0, 'conceded_goals': 0, 'points': 0, 'display_name': 'C4', 'wins': 0,
               'draws': 0, 'losses': 0},
        ...
        'D3': {'group': 'D', 'scored_goals': 0, 'conceded_goals': 0, 'points': 0, 'display_name': 'D3', 'wins': 0,
               'draws': 0, 'losses': 0},
        'D4': {'group': 'D', 'scored_goals': 0, 'conceded_goals': 0, 'points': 0, 'display_name': 'D4', 'wins': 0,
               'draws': 0, 'losses': 0},
    },
    'matches': [
        {'id': 1, 'players': [('A1', 'B1'), ('A2', 'B2')], 'result': None, 'description': '16:00'},
        {'id': 2, 'players': [('C1', 'D1'), ('C2', 'D2')], 'result': None, 'description': '16:00'},
        {'id': 3, 'players': [('A3', 'B3'), ('A4', 'B4')], 'result': None, 'description': '16:15'},
        {'id': 4, 'players': [('C3', 'D3'), ('C4', 'D4')], 'result': None, 'description': '16:15'},
        {'id': 5, 'players': [('A1', 'B3'), ('A3', 'B1')], 'result': None, 'description': '16:30'},
        {'id': 6, 'players': [('C1', 'D3'), ('C3', 'D1')], 'result': None, 'description': '16:30'},
        {'id': 7, 'players': [('A2', 'B4'), ('A4', 'B2')], 'result': None, 'description': '16:45'},
        {'id': 8, 'players': [('C2', 'D4'), ('C4', 'D2')], 'result': None, 'description': '16:45'},
        {'id': 9, 'players': [('A1', 'B2'), ('A4', 'B3')], 'result': None, 'description': '17:00'},
        {'id': 10, 'players': [('C1', 'D2'), ('C4', 'D3')], 'result': None, 'description': '17:00'},
        {'id': 11, 'players': [('A3', 'B4'), ('A2', 'B1')], 'result': None, 'description': '17:15'},
        {'id': 12, 'players': [('C3', 'D4'), ('C2', 'D1')], 'result': None, 'description': '17:15'},
        {'id': 13, 'players': [('A1', 'D1'), ('A2', 'D2')], 'result': None, 'description': '17:30'},
        {'id': 14, 'players': [('C1', 'B1'), ('C2', 'B2')], 'result': None, 'description': '17:30'},
        {'id': 15, 'players': [('A3', 'D3'), ('A4', 'D4')], 'result': None, 'description': '17:45'},
        {'id': 16, 'players': [('C3', 'B3'), ('C4', 'B4')], 'result': None, 'description': '17:45'},
        {'id': 17, 'players': [('A1', 'D3'), ('A3', 'D1')], 'result': None, 'description': '18:00'},
        {'id': 18, 'players': [('C1', 'B3'), ('C3', 'B1')], 'result': None, 'description': '18:00'},
        {'id': 19, 'players': [('A2', 'D4'), ('A4', 'D2')], 'result': None, 'description': '18:15'},
        {'id': 20, 'players': [('C2', 'B4'), ('C4', 'B2')], 'result': None, 'description': '18:15'},
        {'id': 21, 'players': [('A1', 'D2'), ('A4', 'D3')], 'result': None, 'description': '18:30'},
        {'id': 22, 'players': [('C1', 'B2'), ('C4', 'B3')], 'result': None, 'description': '18:30'},
        {'id': 23, 'players': [('A3', 'D4'), ('A2', 'D1')], 'result': None, 'description': '18:45'},
        {'id': 24, 'players': [('C3', 'B4'), ('C2', 'B1')], 'result': None, 'description': '18:45'},
    ]
}
knockout_matches = [
    ...
    {'id': 'VF3', 'round': 'Viertelfinale 3', 'teams': [None, None], 'result': None, 'description': '18:15'},
    {'id': 'VF4', 'round': 'Viertelfinale 4', 'teams': [None, None], 'result': None, 'description': '18:15'},
...
def update_knockout_stage():
    ...
    knockout_matches[0]['teams'] = [[g(A, 1), g(B, 1)], [g(C, 4), g(D, 4)]]
    knockout_matches[1]['teams'] = [[g(C, 1), g(D, 1)], [g(A, 4), g(B, 4)]]
    knockout_matches[2]['teams'] = [[g(A, 2), g(B, 2)], [g(C, 3), g(D, 3)]]
    knockout_matches[3]['teams'] = [[g(C, 2), g(D, 2)], [g(A, 3), g(B, 3)]]
    ...
    knockout_matches[4]['teams'] = [get_winner(knockout_matches[0]), get_winner(knockout_matches[3])]  # HF1
    knockout_matches[5]['teams'] = [get_winner(knockout_matches[1]), get_winner(knockout_matches[2])]  # HF2
    ...
    #knockout_matches[4]['teams'] = [get_semiloser(knockout_matches[2]), get_semiloser(knockout_matches[3])]  # P34
    knockout_matches[6]['teams'] = [get_winner(knockout_matches[4]), get_winner(knockout_matches[5])]  # Final
